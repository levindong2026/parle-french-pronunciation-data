# Ressources ouvertes de prononciation française Parle
...
- CSV canonique : https://getparle.app/french-sound-chart.csv
- Copie versionnée : [french-sound-chart.csv](./french-sound-chart.csv)
- Tableau pédagogique en français : https://getparle.app/resources/tableau-35-sons-francais/
...
- CSV canonique : https://getparle.app/french-speaking-course-map.csv
- Copie versionnée : [french-speaking-course-map.csv](./french-speaking-course-map.csv)
- Carte du parcours : https://getparle.app/french-speaking-course/
- Ressources pédagogiques en français : https://getparle.app/ressources-pedagogiques-prononciation-francaise/

La carte décrit les étapes, unités, missions, objectifs d'apprentissage, contextes, durées estimées et sons associés. Elle ne publie ni dialogues complets, ni réponses attendues, ni enregistrements d'utilisateurs, ni données personnelles.

## Limites d'interprétation

L'entraîneur de voyelles est un outil pédagogique de première partie pour 14 voyelles orales et nasales du tableau. Il lit des fichiers audio intégrés au site et n'enregistre, ne téléverse, n'analyse et ne note pas la voix de l'apprenant.

Dans l'application, Phrase Match indique les mots du modèle que la reconnaissance vocale a détectés. Ce résultat n'est pas une note d'accent, de qualité de prononciation, de fluidité, de niveau ou de CECRL. Parle propose un entraînement oral éducatif ; il ne délivre pas de certification CECRL, ne remplace pas une prise en charge orthophonique et ne promet pas un accent natif.

## Produit officiel

- Site : https://getparle.app/
- Présentation de l'application : https://getparle.app/app/
- Apple App Store : https://apps.apple.com/us/app/parle-french-pronunciation/id6761505050
- Informations presse et ressources actuelles : https://getparle.app/press/

## Version, source de référence et citation
...
Ces références diffusent ou décrivent des données de première partie publiées par Parle. Elles ne constituent pas des avis, recommandations ou validations indépendantes. Aucune archive Zenodo `v2026.08.27` n'est revendiquée ici.
